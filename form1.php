<?php
require_once('list.php'); // Assuming this file contains your database connection details
...
<div class="fields">
    ...
    <tr>
        ...
        <td>
            <button onclick="viewFunction(<?php echo $row['id']; ?>)">View</button>
...
function updateFunction(id) {
    ...
    xhttp.open("GET", "update.php?id=" + id, true); // Prepare the request to update.php with the employee ID
    xhttp.send(); // Send the request
}
...
function deleteFunction(id) {
    ...
    xhttp.open("GET", "delete.php?id=" + id, true); // Prepare the request to delete.php with the employee ID
    xhttp.send(); // Send the request
}
